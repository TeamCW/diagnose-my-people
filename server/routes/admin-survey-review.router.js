    ...
    if (req.isAuthenticated()) {
        pool.connect(function (errorConnectingToDatabase, client, done) {
            if (errorConnectingToDatabase) {
                ...
                client.query(`SELECT client.point_of_contact AS client_name, client.organization AS client_organization, 
            client.contact_email AS client_email, client.contact_number AS client_number, client.survey_hash AS survey_url, client.comments, client.logo_url,
